...
//  Language file. To add a language: copy this file, rename it with its
//  BCP 47 code (e.g. fr-FR.js, es-ES.js), translate the values, and add
//  its <script> tag in index.html.
//  Character proper names (Maddalena, Gallo…) are NOT translated.
// ═══════════════════════════════════════════════════════════════════

I18N['en-US'] = {
  label: 'English',
  flag: '🇺🇸',
  title: 'Eliana’s World',
  enter: 'tap to enter',
  clear: 'Clear',
  friends: 'The friends',
